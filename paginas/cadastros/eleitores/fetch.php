...
if($_SESSION['usuario']['perfil'] == 'u') $where = " and a.assessor = '{$_SESSION['usuario']['codigo']}' ";

echo $query = "SELECT b.*, m.municipio AS municipio, a.nome assessor FROM eleitores b "
